...
public class NearToEntranceParkingStrategy implements ParkingStrategyService {
    @Override
    public Optional<ParkingSpot> findParkingSpot(List<ParkingSpot> parkingSpots, Vehicle.VehicleType type) {
        return parkingSpots.stream()
                ...
                .min(Comparator.comparingInt(ParkingSpot::getNearbyDistanceToEntranceInMeter));
    }
