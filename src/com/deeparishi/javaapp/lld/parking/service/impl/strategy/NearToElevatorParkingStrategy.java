...
public class NearToElevatorParkingStrategy implements ParkingStrategyService {
    ...
    public Optional<ParkingSpot> findParkingSpot(List<ParkingSpot> parkingSpots, Vehicle.VehicleType type) {
        return parkingSpots
                ...
                .min(Comparator.comparingInt(ParkingSpot::getNearbyDistanceToElevatorInMeter));
    }
